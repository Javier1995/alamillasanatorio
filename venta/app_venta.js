...
var total_vendidos = $('#total_vendido');
var pedidos = $('#pedidos');
var productos = $("#productos");
productos.on("load", TotalProductos());
lista_pedidos.on("load", PaginationOrder());
total_vendidos.on("load", Total());
...
function Total() {
    ...
    $.ajax({
        ...
        beforeSend: function () {
            var table = '';
            table += '<div class="preloader-wrapper big active">';
            table += '<div class="spinner-layer spinner-blue-only">';
            table += '<div class="circle-clipper left">';
            table += '<div class="circle"></div>';
            table += '</div><div class="gap-patch">';
            table += '<div class="circle"></div>';
            table += '</div><div class="circle-clipper right">';
            table += '<div class="circle"></div>';
            table += '</div>';
            table += '</div>';
            table += '</div>';
            total_vendidos.html(table);
        ...
        success: (data) => {
            ...
            total_vendidos.html(formatter.format(data.total));
